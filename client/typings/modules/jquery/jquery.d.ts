...
interface JQuery {
    ...
    */
    ...
    /**
     * Adds a transition to the object thanks to semantic ui animation
     *
     * @param description The description of the transition
     */
    transition(description: any): JQuery;

    /**
     * Do action on a form element
     *
     * @param the action applied on the form
     */
    form(action: any): any;

    /**
     * Do semantic-ui action on a modal element
     * @param  {any} action the action applied
     */
    modal(action : any) : any;
